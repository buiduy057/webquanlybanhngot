...
Route::get('chitietsanpham/{id}','PagesController@chitietsanpham')->name('chitietsp');
...
Route::post('themgiohangnhieu/{id}','PagesController@themgiohangnhieu')->name('themgiohangnhieu');
