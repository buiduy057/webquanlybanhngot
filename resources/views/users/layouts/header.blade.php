			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="header-left-menu">
					<div class="welcome-info">
						Chào mừng bạn ghé thăm shop chúng tôi !!!!
					</div>
				</div>
			</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<!-- LOGO START -->
				<div class="logo">
					<a href="{{route('trangchu')}}"><img src="users/img/logo2.png" alt="bstore logo" /></a>
				</div>
				<!-- LOGO END -->
				<!-- HEADER-RIGHT-CALLUS START -->
				<div class="header-right-callus">
					<h3>Gọi hỏi đáp: </h3>
					<span>0386-556-593</span>
				</div>
				...
				<div class="categorys-product-search">
					<form action="{{route('timkiemtheosanpham')}}" method="GET">
						...
						<div class="search-product form-group">
							<input type="text" class="form-control search-form" autocomplete="off" name="search" placeholder="Tìm kiếm theo sản phẩm... " />
							<button class="search-button btn-tk" value="Search"  type="submit">
