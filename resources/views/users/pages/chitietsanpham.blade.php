			...
			<div class="row">
				...
				<div class="col-lg-7 col-md-7 col-sm-8 col-xs-12">
					<div class="single-product-descirption">
						...
						<br>
						<form action="themgiohangnhieu/{{$product->id}}" method="POST" id="frm-add-{{$product->id}}">
								@csrf
						<div class="single-product-quantity">
							<p class="small-title">Số lượng:</p> 
							<div class="cart-quantity">
								<div class="cart-plus-minus-button single-qty-btn">
									<input class="cart-plus-minus sing-pro-qty" type="text" name="soluong" value="0">
								</div>
							</div>
						</div>
					...
					<div class="tab-pane" id="review">
						...
						<div class="primari-box registered-account">
							...
							<form class="new-account-box" id="accountLogin" method="post" action="{{route('binhluantheosp',$product->id)}}">
								...
								<input type="hidden" name="page" value="chitietsp">
