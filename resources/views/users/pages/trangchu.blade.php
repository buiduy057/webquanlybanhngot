	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		...
		<div class="single-left-sidebar sidebar-left-add">
			<div class="sidebar-left zoom-img">
				<a href="javascript::;"><img src="users/img/new/banh-trai-cay-1.png"  alt="bánh trái cây" /></a>
			</div>	
		</div>
		<div class="single-left-sidebar sidebar-best-seller">
			<div class="left-title-area">
				<h2 class="left-title">Bánh mặn</h2>
			</div>
			<div class="row">
		...
		<div class="row">
										...
										<div class="new-product">
											<div class="single-product-item">
												<div class="product-image">
													<a href="chitietsanpham/{{$pt->id}}"><img src="users/img/product/{{$pt->image}}" height="190px" alt="{{$pt->name}}" /></a>
			...
			<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
				...
				<div class="tow-column-add zoom-img">
					<a href="javascript::;"><img src="users/img/slider/homepage2/3.jpg"  height="211px"  alt="banner" /></a>
				</div>
				<!-- TOW-COLUMN-ADD END -->
			</div>
			<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
				...
				<div class="one-column-add zoom-img">
					<a href="javascript::;"><img src="users/img/slider/homepage2/4.jpg" height="211px"  alt="banner" /></a>
				</div>	
				<!-- TOW-COLUMN-ADD END -->
			</div>	
			<div class="col-xs-12">
				...
				<div class="sale-poduct-area new-product-area">
					<div class="left-title-area">
						<h2 class="left-title">Bánh ngọt</h2>
					</div>
					<div class="row">
	...
	<div class="image-add-area">
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
			...
			<div class="onehalf-add-shope zoom-img">
				<a href="javascript::;"><img src="users/img/slider/homepage2/6.png" height="211px"  alt="banner" /></a>
			</div>
			<!-- SINGLE ADD END -->
		</div>
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<!-- SINGLE ADD START -->
			<div class="onehalf-add-shope zoom-img">
				<a href="javascript::;"><img src="users/img/slider/homepage2/5.jpg" height="211px"  alt="banner" /></a>
			</div>
			<!-- SINGLE ADD END -->
		</div>						
	</div>
...
<div class="row">
	...
	<div class="image-add-area">
		<div class="col-lg-7 col-md-7 col-sm-7 col-xs-12">
			<!-- SINGLE ADD START -->
			<div class="onehalf-add-shope zoom-img">
				<a href="#"><img src="users/img/slider/homepage2/7.jpg" height="211px"  alt="banner" /></a>
			</div>
			<!-- SINGLE ADD END -->
		</div>
		<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
			<!-- SINGLE ADD START -->
			<div class="onehalf-add-shope zoom-img">
				<a href="#"><img src="users/img/slider/homepage2/5.jpg" height="211px"  alt="banner" /></a>
			</div>
			<!-- SINGLE ADD END -->
		</div>						
	</div>
