									...
									<div class="col-lg-6 ">
										<div class="form-group">
										  <form  action="{{route('thongketheongay')}}" method="GET">
											...
											<label>Từ ngày : </label>
											<input type="text" placeholder="Ngày đặt phòng" value="{{request()->date_from}}"  name="date_from" id="date_from" autocomplete="off">
											<label> Đến ngày : </label>
											<input type="text" placeholder="Ngày trả phòng"  value="{{request()->date_to}}" name="date_to" id="date_to" autocomplete="off">
